...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-prom-client/node_modules/prom-client/lib/metrics/heapSizeAndUsed.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-prom-client/node_modules/prom-client/lib/metrics/heapSizeAndUsed.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-prom-client/node_modules/prom-client/lib/metrics/</a> &#187; heapSizeAndUsed.js</div>
</div>
<div class="body">
...
module.exports = function() {
	<span class="missing-if-branch" title="if path not taken" >I</span>if(typeof process.memoryUsage !== 'function') {
...
&nbsp;
	...
	<span class="missing-if-branch" title="else path not taken" >E</span>if(usage &amp;&amp; usage.external) {
...
&nbsp;
    ...
    // process.memoryUsage() can throw EMFILE errors, see #67
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if(memUsage) {
			heapSizeTotal.set(memUsage.heapTotal);
			heapSizeUsed.set(memUsage.heapUsed);
			<span class="missing-if-branch" title="else path not taken" >E</span>if(memUsage.external &amp;&amp; externalMemUsed) {
